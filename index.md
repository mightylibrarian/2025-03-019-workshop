...
address: "Zimmerman Library"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "35.08500799967682"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-106.62114534159124"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "March 19-20, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:00am - 4:00pm MST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Harry Snow", "Karl Benedict", "Danielle E. Maurici-Pollock"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jon Wheeler"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["tq@unm.edu", "jwheel01@unm.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2025-03-19-r-workshop # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
- This workshop is open to affiliates to University of New Mexico.
- This workshop is open to the public.
- If you are interested in attending this workshop, contact tq@unm.edu
  for more information
